...
wget https://download3.vmware.com/software/view/viewclients/CART19FQ4/VMware-Horizon-Client-4.10.0-11053294.x64.bundle -O vmware.bundle
chmod +x vmware.bundle
sudo ./vmware.bundle --console --required
